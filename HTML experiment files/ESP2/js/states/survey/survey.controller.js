...
SurveyController.$inject = ['$location', '$http', '$q', 'mode', 'expId', 'workerId', 'skipCoreSurvey'];
function SurveyController($location, $http, $q, mode, expId, workerId, skipCoreSurvey){
	var vm = this;
	vm.allSurveys;
	vm.surveyIndex;
